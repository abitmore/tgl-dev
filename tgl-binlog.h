...
void bl_do_chat_add_user (struct tgl_state *TLS, tgl_peer_id_t id, int version, long long user, long long inviter, int date);
void bl_do_chat_del_user (struct tgl_state *TLS, tgl_peer_id_t id, int version, long long user);
